...
namespace Destructible2D.Examples
{
	...
	public class D2dDocumentation : ScriptableObject
	{
		public string Title;
...
namespace Destructible2D.Examples
{
	[CustomEditor(typeof(D2dDocumentation))]
	public class D2dDocumentation_Inspector : Editor
	{
		...
		{
			var Target = (D2dDocumentation)target;
